...
/*	let msg = await message.channel.send(`Softbanning ${ message.guild.member(message.mentions.users.first() || message.guild.members.get(args[0]).user.tag}...`)
	...
	let userArg = args[0];
	let reaosn = args.slice(1).join(' ') || 'no reason given'

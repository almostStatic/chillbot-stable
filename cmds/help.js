...
module.exports.run = async(client, message, args, error, getSupport, green, red) => {
	...
	.addField(">chill", "Chill with chillbot!!")
	.addField(">purge [number of messages to delete]", "Delete a certain amount of messages fro the current channel. You can only delete a max of 100 messages at once.")

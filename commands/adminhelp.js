...
if(!message.member.hasPermission('ADMINISTRATOR')){
    ...
    .addField('**/fixmute.all** (This command should not need to be used)', 'In this command, the bot will overwrite permissions for all channels so that the mute role may not send messages')

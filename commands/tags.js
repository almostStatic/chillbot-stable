...
module.exports.run = async (bot, message, args) => {
    ...
    .addField("Tags: (Commands)", `\n **/how2suggest** -> Send an embed explaining how to submit suggestions \n **/how2report** -> Send an embed explaining how to report a user \n **/dev-mode** -> Get instructions on how to enable discord developer mode and its usage`)

...
module.exports.run = async(bot, message, args) =>{
   ...
   .setTimestamp()
    .setFooter("You may access this embed by the command /danbot", 'https://cdn.discordapp.com/avatars/422433314347941896/d3e1c5c58de570746f5ca8e745f11392.png?size=2048')
    message.channel.send(embed)
    let used = new Discord.RichEmbed()
                    .setAuthor(`Command Used:`, bot.user.avatarURL)
                    .setColor(`#81868e`)
                    .setDescription(`/danbot used in ${message.guild.name} (${message.guild.id}) \n ${message.author.username}#${message.author.discriminator}, ${message.author.id}`)
